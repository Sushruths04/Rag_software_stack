...
/**
 * Template #7 (template-library spec 2026-07-11) — "Do paragraph-sized chunks
 * retrieve better?" Re-chunks the bundled ECMA-404 corpus with paragraph
 ...
 */
export const LARGE_CHUNK_RECHUNK_TEMPLATE: GraphDoc = {
  schema_version: 1,
  name: "Large-chunk re-chunking eval",
  meta: {
    created: "2026-07-11T00:00:00Z",
    modified: "2026-07-11T00:00:00Z",
    notes: "Template library #7 — paragraph re-chunk of the bundled ECMA-404 corpus, then hybrid eval. Fully free.",
  },
  blocks: [
    ...
    { id: "k1", type: "chunker", position: { x: 400, y: 220 }, params: { strategy: "paragraph" } },
