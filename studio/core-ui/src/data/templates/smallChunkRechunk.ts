...
/**
 * Template #6 (template-library spec 2026-07-11) — "Do smaller chunks
 * retrieve better?" Re-chunks the bundled ECMA-404 corpus with sliding_256
 * before indexing, then evaluates. The live chunker consumes only
 * `strategy` (window/overlap are inert in rag_gt.blocks.chunker), so no
 * other chunker params are set. Fully free.
 */
export const SMALL_CHUNK_RECHUNK_TEMPLATE: GraphDoc = {
  schema_version: 1,
  name: "Small-chunk re-chunking eval",
  meta: {
    created: "2026-07-11T00:00:00Z",
    modified: "2026-07-11T00:00:00Z",
    notes: "Template library #6 — sliding_256 re-chunk of the bundled ECMA-404 corpus, then hybrid eval. Fully free.",
  },
  blocks: [
    ...
    { id: "k1", type: "chunker", position: { x: 400, y: 220 }, params: { strategy: "sliding_256" } },
