...
/**
 * Template #2 (template-library spec 2026-07-11) — "Does hybrid retrieval
 * beat BM25?" Hybrid baseline over the bundled ECMA-404 corpus: same
 * 5-block shape as Sample A, but hybrid strategy and default match
 * mode. Paths are project-relative; StudioShell stamps them absolute at
 * hydration (needsSampleData).
 */
export const HYBRID_EVAL_TEMPLATE: GraphDoc = {
  schema_version: 1,
  name: "Hybrid retrieval eval",
  meta: {
    created: "2026-07-11T00:00:00Z",
    modified: "2026-07-11T00:00:00Z",
    notes: "Template library #2 — hybrid (BM25 + local embeddings) eval on the bundled ECMA-404 corpus. Fully free.",
  },
  blocks: [
