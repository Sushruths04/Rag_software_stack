...
/**
 * Template #4 (template-library spec 2026-07-11) — "How much recall hides
 * below the top 10?" Hybrid retrieval at top_k=50 over the bundled ECMA-404
 * corpus: same 5-block shape as Sample A, but hybrid strategy and top_k=50
 * for high-recall exploration. Paths are project-relative; StudioShell stamps
 * them absolute at hydration (needsSampleData).
 */
export const WIDE_TOPK_EXPLORATORY_TEMPLATE: GraphDoc = {
  schema_version: 1,
  name: "Wide top_k=50 exploratory pass",
  meta: {
    created: "2026-07-11T00:00:00Z",
    modified: "2026-07-11T00:00:00Z",
    notes: "Template library #4 — hybrid retrieval scored at top_k=50: a high-recall exploratory sweep. Fully free.",
  },
  blocks: [
    ...
    { id: "e1", type: "evaluator", position: { x: 760, y: 220 }, params: { top_k: "50" } },
  ],
  wires: [
